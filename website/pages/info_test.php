...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" method="POST" action="../canvas/game.php">
      <h1 class="h1 mb-3 font-weight-normal">Inizia Test</h1>
      <p>
        In questo livello si richiede di cercare la seguente figura tra <? echo $_SESSION['x']; ?> differenti figure
      </p>
      <?
        include "../core/funzioni.php";
